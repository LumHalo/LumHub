#ifndef ANIMATION_STARS_H
#define ANIMATION_STARS_H
...
public:
    AnimationStars(CRGB* strip, uint8_t numPixels, uint8_t r, uint8_t g, uint8_t b, uint8_t intensity, float speed);
    void start() override;
    void stop() override;
...
private:
    ...
    uint8_t stripStatus[60];

    static void taskFunction(void* parameter);
};

#endif // ANIMATION_STARS_H
